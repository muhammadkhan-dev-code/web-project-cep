        ...
        <div class="row">
            ...
            <main class="col-lg-9 p-4">
                ...
                <div class="row g-3 mb-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="text-primary me-3" style="font-size:2rem;"><i
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="text-success me-3" style="font-size:2rem;"><i
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="text-warning me-3" style="font-size:2rem;"><i class="fas fa-users"></i>
                                    </div>
                                    <div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="text-danger me-3" style="font-size:2rem;"><i class="fas fa-clock"></i>
                                    </div>
                                    <div>
                ...
                <div class="card border-0 mb-4"
                    style="background:linear-gradient(135deg,var(--accent) 0%,#FB923C 100%); color:#fff;">
