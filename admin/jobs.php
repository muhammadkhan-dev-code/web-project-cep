    ...
    <div class="container-fluid">
        <div class="row">
            <aside class="col-lg-3 bg-light p-3 border-end" style="min-height:100vh;">
                ...
                <a href="../logout.php" class="nav-link text-danger"><i class="fas fa-arrow-right-from-bracket"></i>
                    Logout</a>
            </aside>
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" class="form-control"
                                placeholder="Search jobs or employers..." value="<?= htmlspecialchars($search) ?>">
                        </div>
                    </div>
                    <div class="col-md-2">
            ...
            ?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge <?= $j['type']==='internship'?'bg-primary':'bg-warning text-dark' ?>">
                                        <?= ucfirst($j['type']) ?>
                                    </span>
                                </td>
                                <td>
